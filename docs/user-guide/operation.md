...
3. Prefer sources marked **Hardware** over **Software**. After a host or add-on update that enables hardware decode, restart if needed and **Probe** again; see [Video pauses, jumps, or falls behind](troubleshooting.md#video-pauses-jumps-or-falls-behind).
